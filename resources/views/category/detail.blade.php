                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Kategori ID</th>
                                <td>{{ $category->category_id ?? 'Tidak ada data' }}</td>
                            </tr>
                            <tr>
                                <th>Kategori Name</th>
                                <td>{{ $category->category_name ?? 'Tidak ada data' }}</td>
                            </tr>
                            <tr>
                                <th>Parent ID</th>
                                <td>{{ $category->category_type ?? 'Tidak ada data' }}</td>
                            </tr>
                            <tr>
                                <th>Aktif</th>
                                <td>{{ $category->category->category ?? 'Tidak ada data' }}</td>
