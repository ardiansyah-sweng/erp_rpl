    ...
    <div class="container-fluid">
      ...
      <form id="picForm" method="POST" action="{{ route('supplier.pic.update', $pic->id) }}" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="supplier_name" name="supplier_name" value="{{ $supplier->company_name }}" required>
      ...
      <script>
        function validateForm() {
          ...
          const picName = document.getElementById("name").value.trim();
          ...
          document.getElementById("picNameError").innerText = "";
          document.getElementById("emailError").innerText = "";
          document.getElementById("telephoneError").innerText = "";
          document.getElementById("assignmentDateError").innerText = "";

          // Validasi Nama Supplier
          if (supplierName === "") {
            document.getElementById("NameError").innerText = "Nama Supplier harus diisi.";
            valid = false;
          }

          // Validasi Nama PIC
          if (picName === "") {
            document.getElementById("picNameError").innerText = "Nama PIC harus diisi.";
            valid = false;
          }
          ...
          if (!phonePattern.test(phone)) {
            document.getElementById("telephoneError").innerText = "Nomor telepon harus 10-13 digit angka.";
            valid = false;
          }

          // Validasi Tanggal Penugasan
          if (assignedDate === "") {
            document.getElementById("assignmentDateError").innerText = "Tanggal penugasan harus diisi.";
            valid = false;
          }
