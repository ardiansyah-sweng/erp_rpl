...
<main class="content-wrapper">
  <div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h1>Suppliers</h1>
      <a href="#" class="btn btn-primary">New Supplier</a>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                <th class="text-center">No <i class="fas fa-sort"></i></th>
                <th>ID Supplier <i class="fas fa-sort"></i></th>
                <th>Name <i class="fas fa-sort"></i></th>
                <th>Address <i class="fas fa-sort"></i></th>
                <th>Telephone <i class="fas fa-sort"></i></th>
                <th>PiC <i class="fas fa-sort"></i></th>
