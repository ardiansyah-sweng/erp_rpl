...
<html lang="en">
  ...
  <head>
    ...
    <title>ERP RPL UAD | Detail Material</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Detail Material supplier</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Detail Material supplier</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="container">
                    <form id="picForm">
                        <div class="mb-3">
                            <label for="supplier_id" class="form-label">ID Material</label>
                            <input type="text" class="form-control" id="supplier_id" name="supplier_id" required>
                            <span id="supplierIdError" class="error"></span>
                        </div>
                        <div class="mb-3">
                            <label for="supplier_name" class="form-label">Nama Material</label>
