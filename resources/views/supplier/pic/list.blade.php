                    ...
                    <form action="{{ route('supplier.pic.list') }}" method="GET" class="d-flex ms-auto">
                        <div class="input-group input-group-sm ms-auto" style="width: 450px;">
                            <input type="text" name="keywords" class="form-control"
                                placeholder="Search PIC Supplier">
                        ...
                        <tbody>
                            @forelse($pics as $pic)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/supplier/pic/detail/{{ $pic->id }}"
                                            class="btn btn-sm btn-info">Detail</a>
                                        <a href="#" class="btn btn-sm btn-primary">Edit</a>
                                        <form action="{{ url('/supplier/pic/delete/' . $pic->id) }}" method="POST"
