                ...
                <form action="{{ route('supplier.material.update', $material->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="supplier_id" value="{{ $material->supplier_id }}" disabled>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="company_name" class="form-label">Company Name (Read-only)</label>
                            <input type="text" class="form-control" id="company_name" value="{{ $material->company_name }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="product_id" value="{{ $material->product_id }}" disabled>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="product_name" class="form-label">Product Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="product_name" name="product_name" value="{{ $material->product_name }}" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="base_price" class="form-label">Base Price <span class="text-danger">*</span></label>
                        <input type="number" class="form-control" id="base_price" name="base_price" value="{{ $material->base_price }}" min="0" required>
                    </div>
