    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Tambah Bill Of Material</h3></div>
              <div class="col-sm-6">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="measurement_unit" name="measurement_unit">
                          ...
                          <option value="31" {{ old('measurement_unit') == '31' ? 'selected' : '' }}>PCS</option>
                          <option value="32" {{ old('measurement_unit') == '32' ? 'selected' : '' }}>LITER</option>
