        ...
        <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="card-body p-0">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <button type="button" class="btn btn-sm btn-warning" onclick="editBom(1)">Edit</button>
                                  </td>
                              </tr>
                              <tr>
                                  <td>2</td>
                      ...
                      <div class="modal-content">
                        ...
                        <form id="editBomForm">
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              <label for="edit_bom_name" class="form-label">Nama BOM</label>
                              <input type="text" class="form-control" id="edit_bom_name" required>
                            </div>
                            <div class="mb-3">
                              <label for="edit_measurement_unit" class="form-label">Satuan</label>
                              <input type="text" class="form-control" id="edit_measurement_unit" required>
                            </div>
                            <div class="mb-3">
                              <label for="edit_total_cost" class="form-label">Total Biaya</label>
                              <input type="number" class="form-control" id="edit_total_cost" min="0" required>
                            </div>
                            <div class="mb-3">
                  ...
                  // Mengambil data BOM yang sudah ada, lalu mengisi form edit (form filled)
                  function editBom(id) {
                    fetch(`/bill-of-material/${id}`)
                      .then(res => res.json())
                      .then(data => {
                        document.getElementById('edit_bom_id').value = data.id;
                        document.getElementById('edit_bom_name').value = data.bom_name;
                        document.getElementById('edit_measurement_unit').value = data.measurement_unit;
                        document.getElementById('edit_total_cost').value = data.total_cost;
                        document.getElementById('edit_active').value = data.active ? '1' : '0';

                        var modal = new bootstrap.Modal(document.getElementById('editBomModal'));
                        modal.show();
                      })
                      .catch(err => alert('Gagal mengambil data untuk diedit'));
                  }

                  // Mengirim perubahan form edit ke endpoint update yang sudah ada
                  document.getElementById('editBomForm').addEventListener('submit', function (e) {
                    e.preventDefault();
                    const id = document.getElementById('edit_bom_id').value;
                    ...
                    fetch(`/bill-of-material/${id}`, {
                      ...
                      body: JSON.stringify({
                        bom_name: document.getElementById('edit_bom_name').value,
                        measurement_unit: document.getElementById('edit_measurement_unit').value,
                        total_cost: document.getElementById('edit_total_cost').value,
                        active: document.getElementById('edit_active').value,
                      }),
                    })
                      .then(res => res.json())
                      .then(data => {
                        alert('Bill of Material berhasil diperbarui.');
                        location.reload();
                      })
