    ...
    @if(isset($bom))
        <form method="POST" action="{{ route('bom.update', $bom->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" value="{{ $bom->id }}" disabled>
                <input type="hidden" name="id" value="{{ $bom->id }}">
            </div>
        
            <div class="mb-3">
                <label class="form-label">BOM ID</label>
                <input type="text" name="bom_id" class="form-control" value="{{ old('bom_id', $bom->bom_id) }}" required>
            </div>
        
            <div class="mb-3">
                <label class="form-label">BOM Name</label>
                <input type="text" name="bom_name" class="form-control" value="{{ old('bom_name', $bom->bom_name) }}" required>
            </div>
        
            <div class="mb-3">
                <label class="form-label">Measurement Unit</label>
                <input type="text" name="measurement_unit" class="form-control" value="{{ old('measurement_unit', $bom->measurement_unit) }}" required>
            </div>
        
            <div class="mb-3">
                <label class="form-label">Total Cost</label>
                <input type="number" name="total_cost" class="form-control" value="{{ old('total_cost', $bom->total_cost) }}" required>
            </div>
        
            <div class="mb-3">
                <label class="form-label">Active</label>
                <select name="active" class="form-control" required>
                    <option value="1" {{ old('active', $bom->active) == 1 ? 'selected' : '' }}>Active</option>
                    <option value="0" {{ old('active', $bom->active) == 0 ? 'selected' : '' }}>Inactive</option>
                </select>
            </div>
