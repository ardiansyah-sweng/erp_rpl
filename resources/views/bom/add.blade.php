...
<head>
    ...
    <title>ERP RPL UAD | Tambah Bill Of Material</title>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Tambah Bill Of Material</h3>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <form action="#" method="POST" id="bomForm">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bom_id" name="bom_id"
                                                placeholder="Contoh: BOM-001" value="{{ old('bom_id') }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="bom_name">BOM Name</label>
                                            <input type="text" class="form-control" id="bom_name"
                                                name="bom_name" placeholder="Contoh: BOM-BOM-001"
                                                value="{{ old('bom_name') }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="measurement_unit">Measurement Unit</label>
                                            <select class="form-control" id="measurement_unit"
                                                name="measurement_unit">
                                                <option value="">-- Pilih Satuan --</option>
                                                {{-- Contoh satuan bisa ditarik dari tabel measurement_unit --}}
                                                <option value="31"
                                                    {{ old('measurement_unit') == '31' ? 'selected' : '' }}>PCS</option>
                                                <option value="32"
                                                    {{ old('measurement_unit') == '32' ? 'selected' : '' }}>LITER
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="total_cost"
                                                name="total_cost" placeholder="Contoh: 279763"
