                    ...
                    <tbody>
                      ...
                      <tr class="align-middle">
                        ...
                        <td>
                          ...
                          <form action="{{ route('purchase_orders.delete', $order->po_number) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin ingin menghapus PO {{ $order->po_number }}?');">
                            @csrf
                            @method('DELETE')
