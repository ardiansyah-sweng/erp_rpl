              ...
              <div class="flex items-center mb-4">
                ...
                <button class="ml-2 bg-blue-100 text-blue-500 px-4 py-2 rounded-lg hover:bg-blue-200">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M10 2a8 8 0 106.32 3.906l4.387 4.387a1 1 0 01-1.414 1.414l-4.387-4.387A8 8 0 0010 2zM4 10a6 6 0 1111.32 3.906l-4.387 4.387a1 1 0 01-1.414-1.414l-4.387-4.387A6 6 0 014 10z" clip-rule="evenodd" />
                  </svg>
                  Filter
                </button>
              </div>
