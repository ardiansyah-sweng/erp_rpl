...
<html lang="en">
  <head>
    ...
    <title>ERP RPL UAD | Edit Warehouse</title>
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Edit Warehouse</h3></div>
              <div class="col-sm-6">
      ...
      <footer class="app-footer">
        <div class="float-end d-none d-sm-inline">ERP RPL UAD</div>
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="#" class="text-decoration-none">ERP RPL UAD</a>.
        </strong>
        All rights reserved.
      </footer>
    </div>
