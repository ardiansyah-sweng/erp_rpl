...
<html lang="en">
  <head>
    ...
    <title>ERP RPL UAD | Detail Werehouse</title>
                    ...
                    <div class="card-body">
                      <table class="table table-bordered">
                            ...
                            <tr>
                               ...
                               <tr>
                                <th>is_rm_whouse</th>
                                <td>{{ $warehouse->is_rm_whouse ?? 'Tidak ada data' }}</td>
                            </tr>
                               <tr>
                                <th>is_fg_whous</th>
                                <td>{{ $warehouse->is_fg_whouse?? 'Tidak ada data' }}</td>
                            </tr>
                              <tr>
                                <th>Created </th>
                                <td>{{ $warehouse->created_at ?? 'Tidak ada data' }}</td>
                            </tr>
                              <tr>
                                <th>Update </th>
                                <td>{{ $warehouse->updated_at ?? 'Tidak ada data' }}</td>
                            </tr>
                            <tr>
                                <th>Status Active</th>
                                <td>{{ $warehouse->is_active == 0 ? 'Aktif' : 'Non Aktif' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                <a href="/warehouse" class="btn btn-secondary mt-3">Kembali</a>
            </div>
        </section>
    </div>
