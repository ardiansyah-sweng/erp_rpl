    ...
    <main class="app-main">
        ...
        <div class="container-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-sm-6 d-flex align-items-center">
              ...
              <a href="{{ route('warehouse.create') }}" class="btn btn-primary btn-sm">Tambah</a>
            </div>
      ...
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <form action="{{ route('warehouse.list') }}" method="GET" class="d-flex ms-auto">
            <!-- Search bar berada di ujung kanan -->
            <div class="input-group input-group-sm ms-auto" style="width: 450px;">
              <input type="text" name="search" class="form-control" placeholder="Search Warehouse" aria-label="Search Warehouse" value="{{ request('search') }}">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form action="{{ route('warehouse.delete', ['id' => $warehouse->id]) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
