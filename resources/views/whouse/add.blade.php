          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="/whouse/list">Gudang</a></li>
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Formulir Tambah Gudang</h3>
                </div>
                <form action="{{ route('warehouse.add') }}" method="POST" id="form-add-warehouse">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="warehouse_name">Nama Gudang</label>
                      <input type="text" class="form-control" id="warehouse_name" name="warehouse_name" placeholder="Masukkan nama Gudang" value="{{ old('branch_name') }}">
                    </div>

                    <div class="form-group">
                      <label for="warehouse_address">Alamat</label>
                      <textarea class="form-control" id="warehouse_address" name="warehouse_address" rows="3" placeholder="Masukkan alamat Gudang">{{ old('branch_address') }}</textarea>
                    </div>

                    <div class="form-group">
                      <label for="warehouse_telephone">Telepon</label>
                      <input type="text" class="form-control" id="warehouse_telephone" name="warehouse_telephone" placeholder="Masukkan nomor telepon" value="{{ old('branch_telephone') }}">
                    </div>
