...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="text-dark">Detail Cabang</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Detail Cabang</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <footer class="main-footer text-center">
        <strong>Copyright &copy; 2025 <a href="#">ERP RPL</a>.</strong> All rights reserved.
    </footer>
