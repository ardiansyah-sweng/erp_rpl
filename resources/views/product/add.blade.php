                  ...
                  <form action="{{ route('product.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="product_id" name="product_id" placeholder="Contoh: TTYY" value="{{ old('product_id') }}">
                        </div>
                
                        <div class="form-group">
                            <label for="product_name">Nama Produk</label>
                            <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Contoh: Laptop Gaming" value="{{ old('product_name') }}">
                        </div>
                
                        <div class="form-group">
                            <label for="product_type">Tipe Produk</label>
                            <input type="text" class="form-control" id="product_type" name="product_type" placeholder="Contoh: TTRR" value="{{ old('product_type') }}">
                        </div>
                
                        <div class="form-group">
                            <label for="product_category">Kategori Produk</label>
                            <input type="text" class="form-control" id="product_category" name="product_category" placeholder="Contoh: 1/2/3" value="{{ old('product_category') }}">
                        </div>
