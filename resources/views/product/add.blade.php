...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="container">
                    ...
                    {{-- Bug Fix #1: Tambah action dan method pada form --}}
                    {{-- Bug Fix #2: Tambah @csrf token --}}
                    <form id="productForm" action="{{ route('product.add') }}" method="POST" onsubmit="return validateForm()">
                        ...
                        {{-- Bug Fix #5: Value radio harus sesuai Enum ProductType (FG, RM, HFG) --}}
                        <div class="mb-3">
                        ...
                        {{-- Bug Fix #4: Ubah input text menjadi <select> dengan name="product_category" --}}
                        {{-- Value harus berupa ID (integer) dari tabel category, bukan teks --}}
                        <div class="mb-3">
                        ...
                        {{-- Bug Fix #3: Ubah type="button" menjadi type="submit" --}}
    ...
    <script>
      // Validasi client-side dipanggil via onsubmit pada <form>
      // Return true = form terkirim, return false = form dibatalkan
