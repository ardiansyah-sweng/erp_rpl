            ...
            <div class="row align-items-center">
                ...
                <div class="dropdown d-inline-block ms-2">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="printProductsDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{ route('product.print.type', ['type' => 'FG']) }}" target="_blank">Finished Goods</a></li> // pilih berdasarkan tipe produk
                ...
                <table class="table table-bordered">
                 ...
                 <tbody>
                  ...
                  <tr class="align-middle">
                      ...
                      <td>{{ $product->categoryRelation ? $product->categoryRelation->category : 'Tidak Ada' }}</td> <!-- Nama kategori -->
