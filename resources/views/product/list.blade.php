                ...
                <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6 d-flex align-items-center">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('category.print') }}" target="_blank"
                                    class="btn btn-primary btn-sm">Cetak Kategori</a>
                                <button type="button"
                                    ...
                                    @foreach ($categories->unique('category')->sortBy('category') as $cat)
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('category.print.single', $cat->id) }}"
                                                target="_blank">
                                                Cetak {{ $cat->category }}
                                            </a>
                                        </li>
                            ...
                            <div class="dropdown d-inline-block ms-2">
                                <button class="btn btn-primary btn-sm dropdown-toggle" type="button"
                                    id="printProductsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    Cetak PDF Produk
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="printProductsDropdown">
                                    <li><a class="dropdown-item"
                                            href="{{ route('product.print.type', ['type' => 'ALL']) }}"
                                            target="_blank">Semua Produk</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('product.print.type', ['type' => 'FG']) }}"
                                            target="_blank">Finished Goods</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('product.print.type', ['type' => 'RM']) }}"
                                            target="_blank">Raw Material</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ route('product.print.type', ['type' => 'HFG']) }}"
                                            target="_blank">Half Finished Goods</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($products as $index => $product)
                                <tr class="align-middle">
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                        <a href="/products/detail/{{ EncryptionHelper::encrypt($product->product_id) }}"
                                            class="text-dark">
                                            {{ $product->product_id }}
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" style="display: inline;">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-danger"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus category ini?')">Delete</button>
                                        </form>
                                        <a href="{{ url('/products/detail/' . EncryptionHelper::encrypt($product->product_id)) }}"
