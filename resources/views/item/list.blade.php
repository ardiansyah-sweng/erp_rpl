                        ...
                        <div class="col-sm-6 d-flex align-items-center">
                            ...
                            <div class="dropdown ms-2">
                                <button class="btn btn-primary btn-sm dropdown-toggle" type="button"
                                    id="printOptionsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="bi bi-printer-fill me-1"></i> Cetak PDF
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="printOptionsDropdown">
                                    <li><a class="dropdown-item" href="{{ route('item.report') }}">Semua Item</a>
                                    </li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li>
                                        <p class="dropdown-header">Berdasarkan Tipe Produk</p>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ url('/item/pdf/product/FG') }}">Finished
                                            Goods (FG)</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ url('/item/pdf/product/HFG') }}">Half-Finished Goods (HFG)</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ url('/item/pdf/product/RM') }}">Raw
                                            Materials (RM)</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            @forelse($items as $item)
                                <tr id="row-{{ $item->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a
                                            href="{{ url('/item/detail/' . App\Helpers\EncryptionHelper::encrypt($item->id)) }}"class="btn btn-sm btn-info text-white">Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
