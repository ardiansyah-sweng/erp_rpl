...
class WarehouseControllerTest extends TestCase
{
    ...
    public function test_search_warehouse_by_name()
    {
        ...
        $response = $this->getJson(route('warehouse.search', ['search' => 'Jakarta']));
    ...
    public function test_search_warehouse_by_address()
    {
        ...
        $response = $this->getJson(route('warehouse.search', ['search' => 'Sudirman']));
    ...
    public function test_search_warehouse_by_phone()
    {
        ...
        $response = $this->getJson(route('warehouse.search', ['search' => '12345']));
    ...
    public function test_search_warehouse_returns_no_results()
    {
        ...
        $response = $this->getJson(route('warehouse.search', ['search' => 'NonExistent']));
    ...
    public function test_search_warehouse_on_empty_database()
    {
        ...
        $response = $this->getJson(route('warehouse.search', ['search' => 'any']));
    ...
    public function test_search_returns_collection_structure()
    {
        ...
        // Act
        $response = $this->getJson(route('warehouse.search', ['search' => 'Gudang']));
