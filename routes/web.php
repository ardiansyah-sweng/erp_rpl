...
#Product Update 
Route::put('/product/update/{id}', [ProductController::class, 'updateProduct'])->name('product.updateProduct');
...
Route::get('/item/add', [ItemController::class, 'showAddForm'])->name('item.form');
