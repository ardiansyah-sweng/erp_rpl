...
class getProductByTypeTest extends TestCase
{
    ...
    public function test_get_product_by_type_returns_finished_good_products()
    {
        ...
        foreach ($result as $product) {
            $this->assertEquals(ProductType::FG->value, $product->{ProductColumns::TYPE});
        }
    ...
    public function test_get_product_by_type_returns_raw_material_products()
    {
        ...
        foreach ($result as $product) {
            $this->assertEquals(ProductType::RM->value, $product->{ProductColumns::TYPE});
        }
    ...
    public function test_get_product_by_type_returns_half_finished_goods_products()
    {
        ...
        foreach ($result as $product) {
            $this->assertEquals(ProductType::HFG->value, $product->{ProductColumns::TYPE});
        }
    ...
    public function test_get_product_by_type_returns_empty_collection_when_no_matches()
    {
        ...
        $this->createTestProduct('RM04', 'Raw Material 1', ProductType::RM->value, $category->{CategoryColumns::ID}, 'Test RM Product');
    ...
    public function test_get_product_by_type_returns_all_matching_type_regardless_of_other_attributes()
    {
        ...
        $this->createTestProduct('FG03', 'Finished Product Alpha', ProductType::FG->value, $category1->{CategoryColumns::ID}, 'Description A');
        $this->createTestProduct('FG04', 'Finished Product Beta', ProductType::FG->value, $category2->{CategoryColumns::ID}, 'Description B');
        $this->createTestProduct('FG05', 'Finished Product Gamma', ProductType::FG->value, $category1->{CategoryColumns::ID}, null);
